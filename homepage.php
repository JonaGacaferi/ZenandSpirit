    ...
    <div class="menu">
      <nav class="navbar">
       ...
       <p class="logo">Zen & Spirit</p>
        ...
        <h2 id="h2-header">Find balance, peace, and <br>harmony within yourself.</h2>
        <p id="p-brenda-h2-header">Unleash the power of positive <br>affirmations in our empowering workshops. <br>
          Cultivate a mindset of self-love, resilience,and abundance as <br> you harness the transformative energy of words. <br>
          Through guided exercises and discussions, you'll<br> create a personalized  practice that uplifts and empowers.
        </p>
  </header>
    <body>
    <section class="evente">
      ...
      <div class="flex-box ">
        <div class="kolonat">
              ...
              <p>Explore a variety of classes tailored
              <br> to meet your unique needs</p>
        ...
        <div class="kolonat">
              ...
              <p>Connect with like-minded individuals,
                <br> and nurture your mind and body </p>
              <button class="buttons-flex-box">Learn More</button>
        </div>
        <div class="kolonat">
          <img src="foto3.jpg" height="300px" width="300px">
          <h4>Join Us for a Session</h4>
          <p>Our classes offer a space for growth,  <br> self-discovery and life balance</p>
          <button class="buttons-flex-box">Learn More</button>
    </div>
      </div>
    </section>
